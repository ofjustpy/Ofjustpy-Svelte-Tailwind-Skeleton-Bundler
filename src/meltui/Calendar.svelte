<script lang="ts">
  ...
  import { faChevronRight, faChevronLeft } from '@fortawesome/free-solid-svg-icons'; // Assuming solid icons
...
<section>
  ...
  <div use:melt={$calendar}>
	...
	<FontAwesomeIcon icon={faChevronLeft} size="1.5em"/>
      </button>
      <div use:melt={$heading}>
        {$headingValue}
      </div>
      <button use:melt={$nextButton}>
	<FontAwesomeIcon icon={faChevronRight} size="1.5em"/>
      </button>
    </header>
    <div>
