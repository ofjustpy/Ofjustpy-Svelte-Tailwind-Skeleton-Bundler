...
<!--       <svg class="fill-token w-24" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40 40" -->
<!--          ><path -->
<!--             fill-rule="evenodd" -->
...
<!--       <img class="w-24" src={Logo} alt="Svelte Logo" /> -->
<!--    </div> -->
<!--    <div class="mt-2 space-y-5"> -->
<!--       <h1 class="h1">Let's get cracking bones!</h1> -->
<!--       <p>Start by exploring:</p> -->
<!--       <ul> -->
<!--          <li><code class="code">/src/main.ts</code> - entry file</li> -->
